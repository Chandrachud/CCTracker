...
-(void)doneClicked:(id) sender
{
    ...
    NSInteger row = [dataArray indexOfObject:textField.text];
    if ([self.customDelegate respondsToSelector:@selector(downPickerDidSelectRowAtIndexPath:withPicker:)]) {
        [self.customDelegate downPickerDidSelectRowAtIndexPath:row withPicker:self];
    }
}
